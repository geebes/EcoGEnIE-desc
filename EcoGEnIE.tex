...
are  taken directly from laboratory culture experiments of isolated strains \citep{LeQuere:2005} creating a parameter-dependence on modern cultured species, in addition to a structural one. 
...
\begin{itemize}
\item[$\bullet$] {surface inorganic nutrients} $\xrightarrow[]{\rm production}$ {plankton biomass} $\xrightarrow[]{\rm export}$ {DOM and remineralised nutrients}
\end{itemize}
